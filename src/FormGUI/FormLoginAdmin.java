...
public class FormLoginAdmin extends javax.swing.JFrame {
    ...
    private void CekLogin(){
        try{
            if(textEmail_Kelompok03.getText().equals("") || textPassword_Kelompok03.getPassword().equals("")){
                ...
                st = con.createStatement();
                String sql = ("SELECT * FROM t_akun_admin WHERE email ='" + textEmail_Kelompok03.getText()+"' AND password ='" + String.valueOf(textPassword_Kelompok03.getPassword())+"'");
    ...
    private void initComponents() {
        ...
        panel_Kelompok03.add(labelFood_Kelompok03, new org.netbeans.lib.awtextra.AbsoluteConstraints(848, 20, -1, -1));
        ...
        labelMasukanAkun_Kelompok03.setFont(new java.awt.Font("Urbanist Black", 1, 30)); // NOI18N
        labelMasukanAkun_Kelompok03.setForeground(new java.awt.Color(21, 0, 53));
        labelMasukanAkun_Kelompok03.setText("Masukan Akun Admin");
        panel_Kelompok03.add(labelMasukanAkun_Kelompok03, new org.netbeans.lib.awtextra.AbsoluteConstraints(748, 228, -1, -1));
        ...
        labelBelumPunya_Kelompok03.setText("Hubungi manager, bila belum mempunyai akun");
        ...
        labelGambar_Kelompok03.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Form Login Admin.png"))); // NOI18N
    ...
    private void panelHapus_Kelompok03MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelHapus_Kelompok03MouseMoved
        // TODO add your handling code here:
        panelHapus_Kelompok03.setBackground(new java.awt.Color(57,161,255));
    ...
    private void panelMasukAkun_Kelompok03MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelMasukAkun_Kelompok03MouseMoved
        // TODO add your handling code here:
        panelMasukAkun_Kelompok03.setBackground(new java.awt.Color(57,161,255));
