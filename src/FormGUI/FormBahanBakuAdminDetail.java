 ...
 */
public class FormBahanBakuAdminDetail extends javax.swing.JFrame {
    ...
    private void kodeLaporanOtomatis(){
        if(textKdBahani_Kelompok03.getText().equals("")){
            try {
            setKoneksi();
            String sql="select right (kode_bahan_baku,2)+1 from t_master_bahan_baku";
            ...
            if(rs.next()){
                ...
                while (no.length()<3){
                    no="0"+no;
                    textKdBahani_Kelompok03.setText("CFBH"+no);}
                }
            else 
            {
                textKdBahani_Kelompok03.setText("CFBH001"); 
            }
            } catch (Exception e) 
            {
        }
    ...
    private void TampilkanDataPelanggan(){ 
        try{
            String sql="SELECT * FROM t_master_bahan_baku WHERE kode_bahan_baku ='"+textKdBahani_Kelompok03.getText()+"'";
            java.sql.Connection conn = (Connection)Database.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()){
                String namaBahan = res.getString("nama_bahan_baku");
                String tglMasuk = res.getString("tgl_masuk");
                String satuanJumlah = res.getString("satuan_jumlah");
                String jumlahStok = res.getString("jumlah_bahan_baku");
                String hargaBahan = res.getString("harga_bahan_baku");
    ...
    public void HapusField(){
        ...
        textSatuanJumlahi_Kelompok03.setText("");
    }
    ...
    public FormBahanBakuAdminDetail() {
        initComponents();
        getContentPane().setBackground(new Color(255,255,255));
        textKdBahani_Kelompok03.setText(FormBahanBakuAdmin.textKdBahani_Kelompok03.getText());
        textRahasia_Kelompok03.setText(FormBahanBakuAdmin.textRahasia_Kelompok03.getText());
    ...
    private void initComponents() {
        ...
        labelBahanBaku_Kelompok03.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Icon Bahan Baku.png"))); // NOI18N
        ...
        labelIconEmailOri_Kelompok03.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Icon Jumlah Pesanan.png"))); // NOI18N
    ...
    private void labelSimpanPerubahanl_Kelompok03MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelSimpanPerubahanl_Kelompok03MouseClicked
        ...
        try{
          String sql= "UPDATE t_master_bahan_baku SET nama_bahan_baku ='"+textNamaBahani_Kelompok03.getText()+"',tgl_masuk='"+tanggal
                  +"',satuan_jumlah='"+textSatuanJumlahi_Kelompok03.getText()+"',jumlah_bahan_baku='"+textJumlahStocki_Kelompok03.getText()
                  +"',harga_bahan_baku='"+textHargaBahan_Kelompok03.getText()+"' WHERE kode_bahan_baku='"+textKdBahani_Kelompok03.getText()+"'";
    ...
    private void labelSimpanData_Kelompok03MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelSimpanData_Kelompok03MouseClicked
        ...
        String tanggal = String.valueOf(fm.format(dateTglMasuk_Kelompok03.getDate()));
        try{
          String sql2 = "INSERT INTO t_master_bahan_baku VALUES ('"+textKdBahani_Kelompok03.getText()+ "','" + textNamaBahani_Kelompok03.getText()
                  + "','" + tanggal+ "','" + textSatuanJumlahi_Kelompok03.getText()
                  + "','" + textJumlahStocki_Kelompok03.getText()+ "','" +textHargaBahan_Kelompok03.getText()+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBahanBakuAdminDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBahanBakuAdminDetail().setVisible(true);
            }
        });
    }
